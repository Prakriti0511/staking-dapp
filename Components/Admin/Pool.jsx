                          ...
                          {poolArray.map((pool, index) => (
                            <tr key={index}>
                              <td>
                                ...
                                <span className="red">
                                  {SHORTEN_ADDRESS(pool.depositToken?.address)}{" "} &nbsp; &nbsp; {pool.depositToken?.symbol} &nbsp; &nbsp;
                                  <FaRegCopy
                                    onClick={() => copyAddress(pool.depositToken?.address)}/>
                                </span>
                              </div>
                              </td>
                              <td>
                                ...
                                <span className="green">
                                  {SHORTEN_ADDRESS(pool.rewardToken?.address)}{" "} &nbsp; &nbsp; {pool.rewardToken?.symbol} &nbsp; &nbsp;
                                  <FaRegCopy
                                    onClick={() => copyAddress(pool.rewardToken?.address)}/>
                                </span>
                              </div>
                              </td>
                              <td>
