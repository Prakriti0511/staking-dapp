  ...
  <div className="col-12">
    <div className="invest invest--big">
      ...
      <div className="invest__group">
        <input type="text" id="partnerlink" name="partnerlink" className="form__input"
        defaultValue={`${ADDRESS_EXPLORER}${STAKING_DAPP}`}
        />
        <p className="invest__text">Stake Token stats Crypic Stakes Best return on your investment</p>
